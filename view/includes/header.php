...
<body>
    <header>
        ...
        ?>
        <div class="head-left" >
            <button name="home" class="header-btn" type="button"><a href="http://localhost:3000/home?tag=all">Home</a></button> 
        ...
        <div class="logo">
            <a href="http://localhost:3000/home?tag=all"><img src="IMG/Logo.png" alt="Logo" height="300px"></a>
        </div>
